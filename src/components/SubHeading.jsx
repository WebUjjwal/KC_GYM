...
const SubHeading = ({ headingTitle, tag, mainHeading, description }) => {
  return (
    <>
      <div className="text-center mb-20">
        <div className="relative">
          ...
          <h5 className="w-full flex items-center justify-center gap-3 text-[#d7fb00] lg:text-[16px] lg:leading-6.5 absolute bottom-3 font-medium capitalize">
